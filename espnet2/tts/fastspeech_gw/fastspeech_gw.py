...
class VariationalFastSpeechGW(AbsTTS):
    ...
    def forward(
        ...
        # forward propagation
        outs_mu, outs_ln_var, d_outs, d_mu_outs, d_ln_var_outs, ds_mu, ds_ln_var = self._forward(
            xs,
            ilens,
            ys,
            olens,
    ...
    def inference(
        ...
        outs_mu, outs_ln_var, d_outs, _, _, _, _ = self._forward(
            xs,
            ilens,
            ys,
            olens,
        ...
        return dict(
            feat_gen=outs_mu[0],
            duration=torch.zeros_like(text),
