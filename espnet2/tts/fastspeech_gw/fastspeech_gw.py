...
class VariationalFastSpeechGW(AbsTTS):
    ...
    def forward(
        ...
        # forward propagation
        before_outs, after_outs, _, ds, d_outs, p_outs, e_outs = self._forward(
            xs,
            ilens,
            ys,
            olens,
        ...
        stats = dict(
            ...
            pitch_loss=pitch_loss.item(),
            energy_loss=energy_loss.item(),
            processed_mbins=self.criterion.processed_mbins,
    ...
    def inference(
        ...
        if use_teacher_forcing and False:
            ...
            _, outs, func, _, d_outs, p_outs, e_outs = self._forward(
                xs,
                ilens,
                ys,
                olens,
